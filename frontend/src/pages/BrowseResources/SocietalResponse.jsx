...
const SocietalResponse = () => {
    return (
        <div className={styles.container}>
            <div className={styles.societalResponseColoredBar}>
                <h1 className={styles.resourceTitle}>Societal Response </h1>
...
export default SocietalResponse;